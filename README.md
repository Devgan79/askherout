...
Envelope initially acts as a “start” screen that reveals the letter content on click.<br>

<h3>When YES is clicked:<br></h3>

Title updates to a celebratory message.<br>

Cat dance animation plays.<br>

Final text appears while buttons vanish.<br>

JavaScript binds all these interactions using event listeners in script.js.<br>
